 ...
 * (walls, openings, axis bubbles) whose corners project upward into an
    ...
    >
      <defs>
        <linearGradient id="avGlass" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="55%" stopColor="#a9c3da" />
          <stop offset="100%" stopColor="#8fb0cc" />
        </linearGradient>
        ...
        <linearGradient id="avSide" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#c3ccd9" />
          <stop offset="100%" stopColor="#9dadc2" />
        </linearGradient>
        ...
        <linearGradient id="avShadow" x1="0" y1="0" x2="1" y2="0">
          ...
          <stop offset="50%" stopColor="#0c1736" stopOpacity="0.14" />
      ...
      {/* sheet margin + title-block strip */}
      ...
      <text x="52" y="494" fontFamily="monospace" fontSize="10" fill="#6d7a90" letterSpacing="2">ELHABAK — CONCEPT STUDY</text>
      <text x="572" y="494" fontFamily="monospace" fontSize="10" fill="#6d7a90" letterSpacing="1" textAnchor="end">SCALE 1:100</text>
      ...
      {/* plan dimension rail (top of plan) */}
      ...
      <text x="170" y="278" fontFamily="monospace" fontSize="10" fill="#e87625" textAnchor="middle" letterSpacing="1">12.40 M</text>

      {/* plan axis bubbles */}
      <g stroke="#1c2f52" strokeWidth="1" fill="#fff">
        <circle cx="72" cy="462" r="9" />
        <circle cx="170" cy="462" r="9" />
        <circle cx="268" cy="462" r="9" />
      </g>
      <g fontFamily="monospace" fontSize="9" fill="#1c2f52" textAnchor="middle">
        <text x="72" y="465">1</text>
        <text x="170" y="465">2</text>
        <text x="268" y="465">3</text>
      </g>
      <text x="88" y="340" fontFamily="monospace" fontSize="10" fill="#6d7a90" letterSpacing="2">PLAN</text>
      ...
      {/* base volume — concrete mass w=170 h=128, depth vector (44,-22) */}
      <g>
        ...
        {/* front face mullions */}
        <g stroke="#1c2f52" strokeOpacity="0.55" strokeWidth="0.9">
      ...
      <g>
        ...
        <rect x="336" y="238" width="210" height="9" fill="#8b98ac" stroke="#1c2f52" strokeWidth="1.3" />
        <polygon points="546,238 590,216 590,225 546,247" fill="#a9b6c9" stroke="#1c2f52" strokeWidth="1.3" />
      </g>
      ...
      {/* model dimension rail (right side) */}
      <g stroke="#e87625" strokeWidth="1.1" fill="none">
      ...
      <text x="612" y="332" fontFamily="monospace" fontSize="10" fill="#e87625" transform="rotate(-90 612 328)" letterSpacing="1">9.60 M</text>

      {/* section cut mark through the model */}
      ...
      <g fontFamily="monospace" fontSize="10" fill="#e87625" textAnchor="middle">
        <text x="330" y="172">A</text>
        <text x="330" y="268">A</text>
      </g>

      {/* model label */}
      <text x="392" y="200" fontFamily="monospace" fontSize="10" fill="#6d7a90" letterSpacing="2">MASSING MODEL</text>

      {/* north arrow */}
      <g transform="translate(596 60)">
        <circle r="14" fill="none" stroke="#1c2f52" strokeOpacity="0.4" />
        <path d="M0 8 V-8 M0 -8 L-4 -1 M0 -8 L4 -1" stroke="#e87625" strokeWidth="1.6" fill="none" />
        <text y="-20" fontFamily="monospace" fontSize="10" fill="#1c2f52" textAnchor="middle">N</text>
      </g>
    </svg>
  );
}
